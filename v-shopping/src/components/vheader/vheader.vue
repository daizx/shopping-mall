  ...
  <div class="navbar">
    <div class="navbar-left-container">
      ...
      <div class="navbar-menu-container">
        ...
        <a href="javascript:void(0)" class="navbar-link"  @click="loginModalFlag=true"  v-if='!name'>Login</a>
        <a href="javascript:void(0)" class="navbar-link" @click="logout"   v-if='name'>Logout</a>
      </div>
    </div>
  </div>
            ...
            <div class="md-content">
              <div class="confirm-tips">
                <div class="error-wrap">
                  <span class="error error-show" v-show="errorSw">用户名或者密码错误</span>
                </div>
                <ul>
...
export default {
  ...
  methods:{
    login(){
      ...
      this.$http.post('/users/login',{userName:this.userName,userPwd:this.userPwd}).then((response)=>{
